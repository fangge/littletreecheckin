...
新增每日任务进度弹窗功能，用户每天首次打开应用时自动展示每个孩子的任务完成情况。

- ✅ **新增** `src/components/TodayProgressModal.tsx`：每日任务进度弹窗组件
- ✅ **新增** 自动触发机制：用户登录后延迟 800ms 自动检测并弹出（每天仅显示一次）
- ✅ **新增** 进度展示：显示孩子任务完成数/总数、动态进度条、智能鼓励文字
