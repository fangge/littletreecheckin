      ...
      <div className="p-6 space-y-6">
        ...
        <div className="text-center">
          <p className="text-sm text-slate-500">
            还没有账户？ <button onClick={onRegister} className="text-primary font-bold">新用户注册</button>
          </p>
        </div>
        ...
        <div className="flex justify-center gap-6">
          <button className="w-12 h-12 flex items-center justify-center rounded-full bg-emerald-50 text-emerald-600 transition-transform active:scale-90">
          ...
          <button className="w-12 h-12 flex items-center justify-center rounded-full bg-slate-50 text-slate-800 transition-transform active:scale-90">
